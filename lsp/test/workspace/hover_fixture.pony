...
class ComplexTypesDemo
  ...
  fun demo_complex_types(): String =>
    ...
    """
    let union_type: (String | U32 | None) = "test"      // Hover shows: let union_type: (String | U32 | None)
    let tuple_type: (String, U32, Bool) = ("test", U32(42), true)  // Hover shows: let tuple_type: (String, U32, Bool)
